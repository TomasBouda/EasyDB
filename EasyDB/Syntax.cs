...
namespace EasyDB
{
	public static class Syntax
	{
		...
		public static readonly Style PurpleStyle = new TextStyle(Brushes.Purple, null, FontStyle.Regular);
		public static readonly Style Highlight = new TextStyle(null, Brushes.Orange, FontStyle.Regular);

		public static void SetSyntaxSql(this FastColoredTextBoxNS.Range range)
		{
